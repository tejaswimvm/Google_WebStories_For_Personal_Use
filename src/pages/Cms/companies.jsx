...
import { CompanyCard } from "@cms-sections/companies/company-card";
import { CompaniesSearch } from "@cms-sections/companies/companies-search";
...
const Page = () => (
  <>
    <Head>
      <title>Companies | CreateStories</title>
    </Head>
    <Box
      component="main"
      sx={{
